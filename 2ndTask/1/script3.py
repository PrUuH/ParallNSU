...
grouped_data = data.groupby(['Threads', 'Matrix Size'])[['Runtime (s)', 'Speedup']].mean().reset_index()

pivot_runtime = grouped_data.pivot(index='Matrix Size', columns='Threads', values='Runtime (s)')
